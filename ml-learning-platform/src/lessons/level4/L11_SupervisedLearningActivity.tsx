...
function LabelTheData() {
  ...
  return (
    <div className="space-y-5">
      <RikuSays>
        Supervised learning = learning with a cheat sheet. The labels ARE the cheat sheet, and every row of your dataset gets one.
      </RikuSays>

      {/* Hero: a real trained classifier so students see what labels UNLOCK */}
      <div className="card-sketchy notebook-grid p-4">
        <h3 className="font-hand text-sm font-bold text-foreground text-center mb-2">
          Once data is labeled, an algorithm can learn the boundary. Try clicking below to classify a new point.
        </h3>
        <KNNViz initialK={3} />
        <p className="font-hand text-center text-xs text-muted-foreground mt-2">
          Each dot already has a known label. KNN uses those labels to classify new points you drop in.
        </p>
      </div>

      <div className="card-sketchy p-5 space-y-4">
        <h3 className="font-hand text-sm font-bold text-foreground text-center">Now your turn: click a label, then click shapes to assign it</h3>
    ...
    <div className="space-y-5">
      ...
      <div className="card-sketchy notebook-grid p-5 space-y-4">
        <h3 className="font-hand text-sm font-bold text-foreground text-center">
          Watch a regression model learn a pattern. Click <em>Fit</em> to train on the data, and notice how MSE drops as the line improves.
        </h3>
      ...
      <RikuSays>
        Never test on your training data. That&apos;s like grading yourself on answers you wrote yourself. You&apos;ll get 100% and learn nothing.
      </RikuSays>
...
function SupervisedVsUnsupervised() {
  return (
    <div className="space-y-5">
      ...
      <div className="card-sketchy notebook-grid p-5 space-y-4">
        <h3 className="font-hand text-sm font-bold text-foreground text-center">
          Two flavors of supervised learning: regression (predict a number) and classification (predict a category).
        </h3>
      ...
      <RikuSays>
        Pop quiz: &quot;How much will this house sell for?&quot; is regression. &quot;Is this email spam?&quot; is classification. Different outputs, same cheat sheet idea.
      </RikuSays>
